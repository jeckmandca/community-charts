...
import FullScreenChartModal from '../prototype_full_render/prototype_full_render'; // This will import the .tsx file if it exists
  ...
  return <>
    ...
    <div className="ChartRight">
      <div className="ChartBoxOne">
        ...
        {/* Button to open full-screen chart modal */}
        <FullScreenChartModal chartProps={{ chartOptions }} />
